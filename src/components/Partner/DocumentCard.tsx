...
function DocumentCard({ title, description, isUploaded, onChange }: DocumentSlotProps) {
  ...
  return (
    ...
    >
      ...
      <input ref={fileInputRef} type="file" hidden accept="image/*,.pdf" onChange={handleFileChange} />
    </motion.div>
  );
}
