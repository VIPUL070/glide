  ...
  return (
    <footer className="w-full bg-foreground text-primary border-t-[0.5px] border-white/10 select-none">
      <div className="w-full grid grid-cols-5 min-h-[35vh]">
        ...
        <div className="col-span-5 p-8 flex items-end justify-start border-b-[0.5px] border-white/15"/>

        <div className="col-span-2 flex items-end justify-start px-15 py-10 gap-6">
          <motion.a
            href=""
            target="_blank"
      ...
      <div className="w-full border-t-[0.5px] border-white/15 py-12 px-30 flex items-center justify-end gap-8 text-[12px] tracking-tight">
