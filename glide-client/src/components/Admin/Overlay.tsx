...
export type OverlayState = "idle" | "approve" | "reject";
...
const Overlay = ({
  overlayState,
  onClose,
  approveTitle = "Approve Profile Pipeline",
  approveDescription = "Are you absolute on deploying approval states? This action maps standard parameters and sets live execution flags.",
  rejectTitle = "Provide Rejection Reason",
  rejectDescription = "Please detail the parameters failing compliance validations. This message will be updated in the pipeline ledger.",
  rejectPlaceholder = "Provide rejection details...",
  onApprove,
  onReject,
